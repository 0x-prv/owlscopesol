...
export function eventFingerprint(params:{tokenId:string;eventType:string;severity:number;beforeValue?:unknown;afterValue?:unknown;observationId?:string|null}): string;
export function holderEventFingerprint(params:{tokenId:string;severity:number;previousPct:unknown;currentPct:unknown;currentSnapshotId?:string|null}): string;
export function authorityEventFingerprint(params:{tokenId:string;severity:number;previousState:string;currentState:string;currentSnapshotId?:string|null}): string;
